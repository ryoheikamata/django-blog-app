...
class Category(models.Model):
    name = models.CharField(verbose_name='カテゴリータイトル', max_length=255)
...
class Post(models.Model):
    ...
    content =  MarkdownxField(verbose_name='記事本文')
    ...
    def convart_markdown_to_html(self):
...
class Comment(models.Model):
    ...
    careted_at = models.DateTimeField(verbose_name='作成日', auto_now_add=True)
